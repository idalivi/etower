...
public class Constants {
	 ...
	 * 上传路径
	 */
	public static final String UPLOAD_PATH = "/u/etower/";
	/**
	 * 资源路径
	 */
	public static final String RES_PATH = "/r/etower";
	/**
	 * 模板路径
	 */
	public static final String TPL_BASE = "/WEB-INF/t/etower";
	/**
	 * 全文检索索引路径
	 */
	 ...
	 * 列表样式模板路径
	 */
	public static final String TPL_STYLE_LIST = "/WEB-INF/t/etower_sys_defined/style_list/style_";
	/**
	 * 内容分页模板路径
	 */
	public static final String TPL_STYLE_PAGE_CONTENT = "/WEB-INF/t/etower_sys_defined/style_page/content_";
	/**
	 * 列表分页模板路径
	 */
	public static final String TPL_STYLE_PAGE_CHANNEL = "/WEB-INF/t/etower_sys_defined/style_page/channel_";
	/**
	 * 页面禁止访问
	 */
