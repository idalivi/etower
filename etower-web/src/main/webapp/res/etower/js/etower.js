...
;(function($) {
    ...
    $.etower.photo_slide = function() {
        ...
        if (! (f != 1 && f < 4)) {
            ...
            if (!$.etower.util.empty(a) && !$.etower.util.empty(a.listID) && !$.etower.util.empty(a.listBtnID) && !$.etower.util.empty(a.feedClassName) && !$.etower.util.empty(a.feedWidth) && $("#" + a.listID).size() != 0) {
                var e = 0,
                d = 1,
                j = null,
                h = [],
                g = null,
                g = $.etower.util.empty(a.feedBoxClass) ? $("#" + a.listID + " ul") : $("#" + a.listID + " ." + a.feedBoxClass),
                k = function() {
    ...
    $.fn.uploader = function(options) {
        var settings = {
            ...
            showMessage: function(message){
                $.etower.tip({content:message, icon:'error'});
            },
            ...
            onComplete: function(id, fileName, result){
                if(result.status == '1'){
                    ...
                    $.etower.tip({content:result.msg, icon:'error'});
                }
            }
        };
        if(options) {
