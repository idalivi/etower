...
public class LoginAction {
	 ...
	 */
	@RequestMapping(value = "/login.esp", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/login.esp", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/logout.esp")
	public String logout(HttpServletRequest request,
		...
		String processUrl = RequestUtils.getQueryParam(request, PROCESS_URL);
		String returnUrl = RequestUtils.getQueryParam(request, RETURN_URL);
		String view = getView(processUrl, returnUrl, null);
		if (view != null) {
			return view;
		} else {
			return "redirect:login.esp";
		}
	}
